...
<html lang="en">
  <head>
    ...
    <!--~~~~~~~~~~~~~~~ Favicon ~~~~~~~~~~~~~~~-->
    <link rel="shortcut icon" href="img/rice bowld.jpg" type="image/x-icon" />
  ...
  />
    ...
    <title>Cita Rasa Kopi & Resbowld</title>
  </head>
  <body>
    <!--~~~~~~~~~~~~~~~ Header ~~~~~~~~~~~~~~~-->
      ...
      <nav class="container relative h-14 flex justify-between items-center">
        <div>
          <a href="#" class="text-2xl uppercase  font-oswald">
            rice<span class="text-secondaryColor">bowld</span>
          </a>
        </div>

        <div class="hidden absolute top-0 left-0 w-full py-14 bg-primaryColor dark:bg-darkColor border-b border-secondaryColor md:block md:static md:py-0 md:border-none md:w-auto md:ml-auto" id="nav-menu">
    ...
    <main>
      ...
      <section id="home">
        <div class="container flex flex-col items-center gap-10 md:flex-row">
          <div class="mx-auto md:basis-1/2 lg:basis-2/5 animate-movingY">
            <img src="./img/rice bowld.jpg" alt="home image" class="home__image w-60 md:w-full">
          </div>

          <div class="home__content text-center md:basis-1/2 md:text-start lg:basis-3/5">
            <h1 class="home__title">Selamatkan perut dengan rice bowld lezat.</h1>
            <div class="separator mx-auto md:mx-0"></div>
            <p class="paragraph">Inilah produk bebas lemak jahat yang paling menakjubkan di tahun 2023! Terbukti mencegah kenaikan berat badan dengan konsumsi teratur!.</p>
        ...
        <div class="container flex flex-col gap-5 md:flex-row">
          ...
          <div class="category__card bg-secondaryColor flex py-3 rounded-lg overflow-hidden md:flex-1">
            <div class="basis-1/3 relative">
              <img src="img/rice bowld.jpg" alt="category image" class="absolute w-28 -bottom-4 -left-4">
            </div>
            ...
            <div>
              ...
              <a href="#" class="text-blackColor cursor-pointer">Buy online</a>
            </div>
          </div>
          ...
          <div class="category__card bg-redColor flex py-3 rounded-lg overflow-hidden md:flex-1">
            <div class="basis-1/3 relative">
              <img src="img/kopi1.jpg" alt="category image" class="absolute w-28 -bottom-4 -left-4">
            </div>
            ...
            <div>
              ...
              <a href="#" class="text-secondaryColor cursor-pointer">Buy online</a>
            </div>
          </div>
          ...
          <div class="category__card bg-greenColor flex py-3 rounded-lg overflow-hidden md:flex-1">
            <div class="basis-1/3 relative">
              <img src="img/makaroni.jpg" alt="category image" class="absolute w-28 -bottom-4 -left-4">
            </div>
      ...
      <section id="promo">
        <div class="container flex flex-col gap-5 lg:gap-10 lg:flex-row">
          ...
          <div class="promo__card-1 bg-primaryColorLight dark:bg-darkColorLight flex flex-col p-5 rounded-lg md:flex-row md:items-center lg:flex-row-reverse lg:flex-1">
            <img src="img/rice bowld.jpg" alt="promo image" class="w-40 mx-auto hover:animate-movingY md:mx-5">

            <div class="space-y-2 pt-5 md:pt-0">
              <p class="text-xs text-secondaryColor">promo</p>
              <h3 class="card__title">DAPATKAN DISKON 10% PADA MINGGU INI</h3>
              <p class="paragraph">Ayo beli produk kami karena yang lain belum tentu berkualitas"</p>
          ...
          <div class="promo__card-2 bg-primaryColorLight dark:bg-darkColorLight flex flex-col p-5 rounded-lg md:flex-row md:items-center lg:flex-row-reverse lg:flex-1">
            <img src="img/kopi1.jpg" alt="promo image" class="w-40 mx-auto hover:animate-movingY md:mx-5">

            <div class="space-y-2 pt-5 md:pt-0">
              <p class="text-xs text-secondaryColor">promo</p>
              <h3 class="card__title">DAPATKAN DISKON 10% PADA MINGGU INI</h3>
              <p class="paragraph">Jangan lewatkan penawaran terbaik secangkir kopi latte, hanya untuk pembeli setia. Nantikan promonya dan dapatkan tawaran menariknya ya.</p>
              <a href="#" class="text-xs text-secondaryColor">Buy online</a>  
            </div>
          </div>
        </div>
      ...
      <section id="about">
        <div class="container flex flex-col gap-10 md:flex-row">
          <div class="about__img flex-1">
            <img src="img/rice bowld.jpg" alt="about image" width="60%">
          </div>

          <div class="about__content flex-1">
            <h2 class="section__title">TEMUKAN MAKANAN DAN MINUMAN, TEMPAT ALL-IN-ONE UNTUK RASA TERBAIK ANDA.</h2>
            <div class="separator"></div>
            <p class="paragraph">Penting untuk memiliki layanan pelanggan yang baik, penyedia layanan pelanggan.</p>
      ...
      <section id="menu">
        <div class="container">
          <div class="max-w-md mx-auto text-center">
            <h2 class="section__title">MENU TERBAIK KAMI</h2>
            ...
            <ul class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 lg:gap-12">
              ...
              <li class="item_wrap food">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/original.jpg" alt="food image" width="60%" height="60%">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">REGULAR RICE BOWL</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami..</p>
                  </div>

                  <p class="text-secondaryColor">$15.000</p>
                </div>
              </li>

              <li class="item_wrap food">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/rasa ayam.jpg" alt="food image" width="80%" height="100px">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">RICE BOWL BOLA AYAM</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami..</p>
                  </div>

                  <p class="text-secondaryColor">$18.000</p>
                </div>
              </li>

              <li class="item_wrap food">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/rasa udang.jpg" alt="food image" width="80%" height="100px">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">RICE BOWL UDANG</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami..</p>
                  </div>
              ...
              <li class="item_wrap food">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/komplite.jpg" alt="food image" width="80%" height="100px">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">RICE BOWL KOMPLITE</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami..</p>
                  </div>

                  <p class="text-secondaryColor">$20.000</p>
                </div>
              </li>

              <li class="item_wrap food">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/rice bowld.jpg" alt="food image" height="80%" width="40%">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">RICE BOWL SPESIAL</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami.. </p>
                  </div>

                  <p class="text-secondaryColor">$25.000</p>
                </div>
              </li>
              ...
              <li class="item_wrap snack">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/snack-1.png" alt="food image" width="60%" height="100px">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">KENTANG GORENG</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami..</p>
                  </div>

                  <p class="text-secondaryColor">$8.000</p>
                </div>
              </li>

              <li class="item_wrap snack">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/makaroni.jpg" alt="food image" width="40%" height="100px">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">MAKARONI</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami...</p>
                  </div>

                  <p class="text-secondaryColor">$5.000</p>
                </div>
              </li>

              <li class="item_wrap snack">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/resoles.jpg" alt="food image" width="70%" height="100px">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">RISOLES</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami..</p>
                  </div>

                  <p class="text-secondaryColor">$2.000</p>
                </div>
              </li>

              <li class="item_wrap snack">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/snack bola.jpg" alt="food image" width="40%" height="100px">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">BOLA MIE</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami..</p>
                  </div>
              ...
              <li class="item_wrap snack">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/snack dinsam.jpg" alt="food image" height="100px" width="70%">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">DINSUM</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami..</p>
                  </div>

                  <p class="text-secondaryColor">$3.000</p>
                </div>
              </li>

              <li class="item_wrap snack">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/snack udang.jpg" alt="food image" height="80px" width="60%">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">UDANG TEPUNG GORENG</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami..</p>
                  </div>
              ...
              <li class="item_wrap beverage">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/beverage-1.png" alt="food image" class="w-40 hover:scale-110 ease-linear duration-200 md:w-48 lg:w-24">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">JUS PISANG</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami..</p>
                  </div>

                  <p class="text-secondaryColor">$7.000</p>
                </div>
              </li>

              <li class="item_wrap beverage">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/kopi1.jpg" alt="food image" class="w-40 hover:scale-110 ease-linear duration-200 md:w-48 lg:w-24">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">KOPI</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami..</p>
                  </div>
              ...
              <li class="item_wrap beverage">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/mangga.jpg" alt="food image" class="w-40 hover:scale-110 ease-linear duration-200 md:w-48 lg:w-24">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">JUS MANGGA</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami..</p>
                  </div>

                  <p class="text-secondaryColor">$10.000</p>
                </div>
              </li>

              <li class="item_wrap beverage">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/lemon.jpg" alt="food image" class="w-40 hover:scale-110 ease-linear duration-200 md:w-48 lg:w-24">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">JUS LEMON</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami..</p>
                  </div>

                  <p class="text-secondaryColor">Rp.7.000</p>
                </div>
              </li>

              <li class="item_wrap beverage">
                <div class="h-56 grid place-items-center bg-primaryColorLight dark:bg-darkColorLight dark:hover:bg-secondaryColor rounded-3xl hover:bg-secondaryColor ease-linear duration-200 lg:h-40">
                  <img src="img/alpukat.jpg" alt="food image" class="w-40 hover:scale-110 ease-linear duration-200 md:w-48 lg:w-24">
                </div>

                <div class="pt-5">
                  <div class="mb-2">
                    <h4 class="card__title">JUS ALPUKAT</h4>
                    <p class="paragraph">Pelanggan itu sangat penting, bagi kami..</p>
                  </div>
      ...
      <!--~~~~~~~~~~~~~~~ Review ~~~~~~~~~~~~~~~-->
      <section id="review" class="bg-primaryColorLight dark:bg-darkColorLight py-20">
        <div class="customer__review container">
          <div class="max-w-md mx-auto text-center">
            <h2 class="section__title">CUSTOMER REVIEW</h2>
            <div class="separator mx-auto"></div>
            <p class="paragraph">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.</p>
          </div>
            ...
            <ul class="swiper-wrapper">
              <li class="swiper-slide">
                <div class="flex flex-col gap-5 bg-primaryColor dark:bg-darkColor rounded-lg p-6">
                  <p class="paragraph">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique culpa ut amet voluptas asperiores alias sed consequatur.</p>
                  <div class="flex items-center">
                    <img src="img/review-1.jpg" alt="review image" class="w-12 h-12 rounded-full">
                    <div class="ml-2">
              ...
              <li class="swiper-slide">
                <div class="flex flex-col gap-5 bg-primaryColor dark:bg-darkColor rounded-lg p-6">
                  <p class="paragraph">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique culpa ut amet voluptas asperiores alias sed consequatur.</p>
                  <div class="flex items-center">
                    <img src="img/review-2.jpg" alt="review image" class="w-12 h-12 rounded-full">
                    <div class="ml-2">
                      <p class="font-oswald uppercase">John doe</p>
                      <p class="paragraph">Designer</p>
                    </div>
              ...
              <li class="swiper-slide">
                <div class="flex flex-col gap-5 bg-primaryColor dark:bg-darkColor rounded-lg p-6">
                  <p class="paragraph">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique culpa ut amet voluptas asperiores alias sed consequatur.</p>
                  <div class="flex items-center">
                    <img src="img/review-3.jpg" alt="review image" class="w-12 h-12 rounded-full">
                    <div class="ml-2">
                      <p class="font-oswald uppercase">John doe</p>
                      <p class="paragraph">Designer</p>
                    </div>
              ...
              <li class="swiper-slide">
                <div class="flex flex-col gap-5 bg-primaryColor dark:bg-darkColor rounded-lg p-6">
                  <p class="paragraph">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique culpa ut amet voluptas asperiores alias sed consequatur.</p>
                  <div class="flex items-center">
                    <img src="img/review-4.jpg" alt="review image" class="w-12 h-12 rounded-full">
                    <div class="ml-2">
                      <p class="font-oswald uppercase">John doe</p>
                      <p class="paragraph">Designer</p>
                    </div>
              ...
              <li class="swiper-slide">
                <div class="flex flex-col gap-5 bg-primaryColor dark:bg-darkColor rounded-lg p-6">
                  <p class="paragraph">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique culpa ut amet voluptas asperiores alias sed consequatur.</p>
                  <div class="flex items-center">
                    <img src="img/review-5.jpg" alt="review image" class="w-12 h-12 rounded-full">
                    <div class="ml-2">
                      <p class="font-oswald uppercase">John doe</p>
                      <p class="paragraph">Designer</p>
                    </div>
      ...
      <section class="footer">
        <div class="container">
          <ul class="grid grid-cols-1 items-start gap-5 pb-5 md:grid-cols-2 lg:grid-cols-4">
            ...
            <li>
              <div class="flex flex-col gap-3">
                ...
                <a href="" class="text-xs hover:text-secondaryColor">Term & Condition</a>
          ...
          <div class="flex flex-col items-center border-t border-primaryColorLight dark:border-darkColorLight py-5 md:flex-row md:justify-between">
            <p class="paragraph">Burger Template Kit by Light Code</p>
